(window.webpackJsonp=window.webpackJsonp||[]).push([[9],{507:function(E,x,c){"use strict";c.r(x);var f=function(){var o=this,i=o._self._c;return i("canvas",{ref:"canvas",staticClass:"canvas",attrs:{"aria-label":"landing background"}})},p=[],n=c(369),h=`#define GLSLIFY 1
...
`,w=new n.a,g=2.3,v=!1,u=!1,m=!1,e=null,s=16/9,r=null,t=null,l=null,z={mounted:function(){var o=this,i=this.$refs.canvas;v=this.$prefersReducedMotion(),s=window.innerWidth/window.innerHeight,l=new n.f,e=new n.i({powerPreference:"high-performance",precision:"highp",canvas:i}),e.setPixelRatio(Math.min(window.devicePixelRatio,g)),e.outputEncoding=n.j,e.autoClearColor=new n.b(3,3,3),e.failIfMajorPerformanceCaveat=!0,r=new n.d(70,s,.5,2),r.position.set(0,0,1);var a=2,P=new n.e(a*s,a),b=new n.g({fragmentShader:h,vertexShader:y,extensions:{derivatives:"#extension GL_OES_standard_derivatives : enable"},uniforms:{time:{value:0},randomSeed:{value:Math.random()},objectOpacity:{value:v?1:0},noisePower:{value:1},pixelRatio:{value:window.devicePixelRatio},resolution:{value:new n.h(window.innerWidth,window.innerHeight)}},depthTest:!1});t=new n.c(P,b),l.add(t),r.matrixAutoUpdate=!1,t.matrixAutoUpdate=!1,window.addEventListener("resize",this.resize),this.resize(),this.$nuxt.$on("show-shader",function(){u=!0,o.$gsap.to(t.material.uniforms.objectOpacity,{value:1,duration:1.75,delay:.125})}),this.$gsap.ticker.add(this.render)},methods:{resize:function(){var o=e.domElement,i=o.clientWidth,a=o.clientHeight;(o.width!==i||o.height!==a)&&(e.setSize(i,a,!1),r.aspect=i/a,r.updateProjectionMatrix()),r.updateMatrix(),t.updateMatrix(),t.material.uniforms.resolution.value.set(window.innerWidth,window.innerHeight)},render:function(){this.$scrollY()-20>window.innerHeight||!u||v&&m||(v&&(m=!0),t.material.uniforms.time.value=w.getElapsedTime(),e.render(l,r))}}},R=z,_=c(37),C=Object(_.a)(R,f,p,!1,null,null,null),S=x.default=C.exports}}]);
